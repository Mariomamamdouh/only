...
Color secondaryColor = HexColor("000000");
Color tertiaryColor = HexColor("ED625E");
Color alternateColor =HexColor("000000");
...
buildNoAuth(context) {
  ...
  return Column(
    ...
    children: [
      ...
      Text(
        AppLocalizations.of(context).translate("Oops, please login first to use this feature"),
        style: TextStyle(
  ...
  return GestureDetector(
    onTap: () {
      if (product.stockStatus != 'outofstock' && product.productStock >= 1) {
        ...
        snackBar(context, message: AppLocalizations.of(context).translate("Product currently is out of stock"));
      }
    },
    child: Icon(
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          child: Text(
            AppLocalizations.of(context).translate("Something went wrong. Please refresh the app or contact the administrator/developer."),
        ...
        MaterialButton(
          ...
          child: Row(
            ...
            children: [Icon(Icons.refresh), Text(AppLocalizations.of(context).translate('Refresh App'))],
          ),
        )
      ],
    ),
