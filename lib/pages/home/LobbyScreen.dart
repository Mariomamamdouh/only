                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context).translate("Recently Viewed Products"),
                          style: TextStyle(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              AppLocalizations.of(context).translate("Recommendation For You"),
              style: TextStyle(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          AppLocalizations.of(context).translate("Special Promo : App Only")
                          ,
                          style: TextStyle(
                              fontSize: responsiveFont(14),
                              fontWeight: FontWeight.w600),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                AppLocalizations.of(context).translate("Our Best Seller"),
                                                style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: responsiveFont(14),
                                                    fontWeight: FontWeight.w600),
                                                ...
                                                onTap: () {
                                                  Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                          builder: (context) =>
                                                              ProductMoreScreen(
                                                                name:  AppLocalizations.of(context).translate("Our Best Seller"),
                                                                include: products
                                                                    .productBest
                                                                    .products,
                                                              )));
