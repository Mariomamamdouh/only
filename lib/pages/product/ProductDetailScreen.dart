                          ...
                          child: OutlinedButton(
                              ...
                              onPressed: () {
                                if (productModel.stockStatus != 'outofstock' &&
                                  ...
                                  snackBar(context,
                                      message:
                                          AppLocalizations.of(context).translate("Product currently is out of stock"));
                                }
                              },
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context).translate("ON SALE NOW"),
                      style: TextStyle(
                          fontSize: responsiveFont(14),
                          fontWeight: FontWeight.w600),
                    ),
              ...
              productModel.type == 'simple'
                ...
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                        text:
                                productModel.productRegPrice+""+AppLocalizations.of(context).translate("EGP"),
                  ...
                  children: <TextSpan>[
                    variantPrices.isEmpty
                        ...
                        text: variantPrices
                            .first ==
                            variantPrices.last
                            ? '${variantPrices.first.toString()}'
                            : '${variantPrices.first}'.toString()+"-" +'${variantPrices.last}',
                        style: TextStyle(
                            fontWeight: FontWeight.w600,
                            fontSize: responsiveFont(15),
                            color: Colors.black)),
                    ...
                    children: <TextSpan>[
                      TextSpan(
                          text: productModel.productPrice.toString(),
                                 ...
                                 // productModel.productRegPrice.toString(),
                          style: TextStyle(
                              decoration:
